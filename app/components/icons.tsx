...
export const HeartIcon: React.FC<HIProps> = ({ isFilled }) => {
  return (
    <>
      <svg width="33" height="33" viewBox="0 0 33 33" fill={isFilled ? "#0acf83" : "none"} xmlns="http://www.w3.org/2000/svg">
        <path d="M22.7475 5.15625C18.5632 5.15625 16.5007 9.28125 16.5007 9.28125C16.5007 9.28125 14.4382 5.15625 10.2539 5.15625C6.85332 5.15625 4.16046 8.00121 4.12566 11.396C4.05476 18.4426 9.71568 23.4538 15.9206 27.6652C16.0916 27.7816 16.2938 27.8438 16.5007 27.8438C16.7076 27.8438 16.9097 27.7816 17.0807 27.6652C23.285 23.4538 28.9459 18.4426 28.8757 11.396C28.8409 8.00121 26.148 5.15625 22.7475 5.15625Z" stroke={isFilled ? "none" : "black"} strokeLinecap="round" strokeLinejoin="round" />
      </svg>
  ...
  return (
    <>
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M18.0195 5.82134L9.8876 13.9533L18.0195 22.0852" stroke="#0ACF83" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
